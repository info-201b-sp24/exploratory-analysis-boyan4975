...
summary_info <- list()
summary_info$number_cities <- nrow(population_climate_1900_2010)
summary_info$number_features <- ncol(population_climate_1900_2010)
summary_info$Regions_median <- population_climate_1900_2010 %>% group_by(Region) %>% summarize(
...
summary_info$Regions_highest <- population_climate_1900_2010 %>% group_by(Region) %>% summarize(
...
summary_info$Regions_lowest <- population_climate_1900_2010 %>% group_by(Region) %>% summarize(
